...
Adafruit_NeoPixel strip0 = Adafruit_NeoPixel(PIXIEL_NUM, PIXIEL_PIN0, NEO_GRB + NEO_KHZ800);
Adafruit_NeoPixel strip1 = Adafruit_NeoPixel(PIXIEL_NUM, PIXIEL_PIN1, NEO_GRB + NEO_KHZ800);
Adafruit_NeoPixel strip2 = Adafruit_NeoPixel(PIXIEL_NUM, PIXIEL_PIN2, NEO_GRB + NEO_KHZ800);
Adafruit_NeoPixel strip3 = Adafruit_NeoPixel(PIXIEL_NUM, PIXIEL_PIN3, NEO_GRB + NEO_KHZ800);
uint32_t RGB[8] = {0xaa0000,0x00aa00,0x0000aa,0xaaaa00,0xaa00aa,0x00aaaa,0x123456,0x654321}; 
